...
class NestedTableVerify extends React.Component
{
  constructor(props)
  {
    super(props);
...
class NestedTableUser extends React.Component
{
  constructor(props)
  {
    super(props);
...
const tableList={
  ...
  'user':NestedTableUser,
  'verify':NestedTableVerify
};
...
export default class RootQuery extends React.Component {
          ...
          handleClick()
          {
            ...
            console.log('backup button');
            var url ='http://127.0.0.1:8070/system/backup';
            var myFetchOptions = {
              method: 'GET',
              // mode:'no-cors',
              headers: {
      ...
      {   /*    <
          ...
          */  }
              ...
              <Button onClick={this.handleClick.bind(this)} type="primary" shape="round">数据备份</Button>
